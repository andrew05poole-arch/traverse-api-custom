                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.RootUrl(req => req.RequestUri.AbsoluteUri.Contains("/swagger/") ? req.RequestUri.AbsoluteUri.Substring(0, req.RequestUri.AbsoluteUri.IndexOf("/swagger/")) : req.RequestUri.AbsoluteUri);
                        ...
                        //
                        c.SingleApiVersion("v2", "Traverse Api");
                        ...
                        //
                        c.OAuth2("oauth2")
                            .Description("OAuth2 Application Grant")
                            .Flow("application")
                            //.AuthorizationUrl("http://petstore.swagger.wordnik.com/api/oauth/dialog")
                            .TokenUrl(TravApiConfig.TokenEndpoint);
                        //.Scopes(scopes =>
                        //{
                        //    scopes.Add("", "General access");
                        //});
                        ...
                        // Operation filters.
                        //
                        c.OperationFilter<ApiSwaggerOperationFilter>();
                        //
                        ...
                        //
                        //c.DocumentFilter<ApiSwaggerDocumentFilter>();
                        ...
                        c.CustomProvider((provider) => new ApiSwaggerProvider(provider));
                    })
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.DocumentTitle(TravApiConfig.UserPortalTitle);
                        ...
                        //
                        c.UImaxDisplayedTags(int.MaxValue);
                        ...
                        c.EnableOAuth2Support(
                            ...
                            realm: "test-realm",
                            appName: string.Format("{0} Test Call", TravApiConfig.UserPortalTitle)
