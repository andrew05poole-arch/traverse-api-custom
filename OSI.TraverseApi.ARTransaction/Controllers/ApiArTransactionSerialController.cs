...
namespace OSI.TraverseApi.AccountsReceivable.Controllers
{
    public class ApiArTransactionSerialController : ApiControllerBase
    {
        ...
        protected override void AddPropertyDelegates()
        {
            ...
            PropertyDictionary.Add(TransactionSerialBase.Columns.CostUnitFgn.ToString(), (entity) => entity.UpdateCosts(true));
        }
        ...
        #region Fields
        public const string FunctionID = "A482C496-64FD-4331-AE65-B899A139A14F";
        #endregion Fields
    }
}
