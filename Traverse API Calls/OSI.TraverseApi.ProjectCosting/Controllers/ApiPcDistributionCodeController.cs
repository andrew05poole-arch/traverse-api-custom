...
{
    public class ApiPcDistributionCodeController : ApiControllerBase
    {
        #region Web Methods
        ...
        {
            if (Provider.Items.Count <= 0 || (!string.IsNullOrEmpty(id) && !Provider.Items.Exists(i => StringHelper.AreEqual(i.DistCode, id, false))))
            {
                ...
                else
                {
                    ...
                    var list = new DistributionCodeProvider().Load(this.CompId, new FilterCriteria(builder.ToString(), string.Empty));
        ...
        private async Task<DistributionCode> Find(string id)
        {
        ...
        protected virtual async Task<List<DistributionCode>> ProcessEditRequest(bool isCreate, dynamic body, string id = null)
        {
            ...
            if (list.Length > 1 && !string.IsNullOrEmpty(id))
                throw new InvalidValueException("Call is ambiguous. DistributionCode ID is provided along with more than one record.");
        ...
        protected virtual async Task<DistributionCode> ProcessBodyItem(bool isCreate, dynamic bodyItem, string id)
        {
            ...
            if (isCreate)
            {
                ...
                throw new InvalidValueException(string.Format("Distribution Code ID '{0}' could not be found.", code));
        ...
        protected virtual async T.Task MarkToDelete(string id)
        {
            ...
            if (entity == null)
                throw new NothingToProcessException(string.Format("Distribution Code ID '{0}' could not be found.", id));
        ...
        #region Fields
        public const string FunctionID = "4C28FE0E-952B-4B36-88F1-A73C73E5C2AA";
        #endregion Fields
    }
}
