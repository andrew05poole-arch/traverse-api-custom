...
namespace OSI.TraverseApi.SalesOrder.Controllers
{
    public class ApiSoTransactionBatchCodeController : ApiControllerBase
    {
        ...
        {
            string code = ApiUserSkipped.IsApiUserSkipped(bodyItem.BatchId) || !string.IsNullOrWhiteSpace(id) ? (bodyItem.BatchId = id) : bodyItem.BatchId;
        ...
        public const string FunctionID = "A91F0A14-CD46-4B3B-B1B1-BB4B0B64B39D";
