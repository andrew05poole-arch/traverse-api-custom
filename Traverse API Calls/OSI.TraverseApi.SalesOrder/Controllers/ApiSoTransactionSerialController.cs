...
{
    public class ApiSoTransactionSerialController : ApiControllerBase
    {
        #region Web Methods
        ...
        protected override void AddPropertyDelegates()
        {
            ...
            PropertyDictionary.Add(TransactionSerialBase.Columns.CostUnitFgn.ToString(), 
        ...
        protected virtual async Task<TransactionSerial> ProcessBodyItem(bool isCreate, dynamic bodyItem, string transId, int entryNum, string id)
        {
            ...
            if (CurrentLineItem != null)
            {
                if (CurrentLineItem.InItem == null || CurrentLineItem.InItem.InventoryType != InventoryType.Serial)
        ...
        protected virtual void SerialNumberPropertyChanged(TransactionSerial entity)
        {
            if (string.IsNullOrEmpty(entity.SerNum)
                ...
                || CurrentLineItem.InItem.InventoryType != InventoryType.Serial)
                return;
            ...
            entity.SetDefaults();
            if (CurrentTransaction.TransactionType == SOTransactionType.Invoice
                || CurrentTransaction.TransactionType == SOTransactionType.Verified)
            {
        ...
        protected virtual void LotNumberPropertyChanged(TransactionSerial entity)
        {
            ...
            if (entity.IsNew &&
                ((TransactionHeader)entity.Parent.Parent).TransactionType == SOTransactionType.CreditMemo &&
                ((TransactionHeader)entity.Parent.Parent).TransactionType == SOTransactionType.RMA &&
                lot == null)
            {
        ...
        {
            if (PropertyDictionary.TryGetValue(e.PropertyName, out Action<TransactionSerial> action))
        ...
        #region Fields
        public const string FunctionID = "19E5CCC8-BAEB-4DEE-8110-5B566FB118D7";
        #endregion Fields
    }
}
