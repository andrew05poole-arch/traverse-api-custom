...
namespace OSI.TraverseApi.WarehouseManagement
{
    ...
    {
        #region Web Methods
        [ApiRoute(FunctionID, 2f, "batch/adjustment/{id?}", typeof(TransactionBatch))]
        ...
        {
            this.PropertyDictionary.Add(TransactionBatch.Columns.DefaultYn.ToString(), ProcessDefaultChange);
            this.PropertyDictionary.Add(TransactionBatch.Columns.Lock.ToString(), ProcessLockChange);
        }
        ...
        protected virtual async Task<List<TransactionBatch>> ProcessEditRequest(bool isCreate, dynamic bodyItem, string id = null)
        {
            object[] list;
        ...
        {
            this.ValidateEntityList(Provider.Items.ChangedItems);
            this.Provider.Update(this.CompId);
        }
        ...
        #region Fields
        public const string FunctionID = "7893caaa-0b68-4792-919d-52e08a0c9436";
        #endregion Fields
    }
}
