...
{
    public class ApiPaEmployerCostCodeController : ApiControllerBase
    {
        #region Web Methods
        [ApiRoute(FunctionID, 2f, "deductcode/employer/{id:int?}", typeof(DeductCode))]
        ...
        [ApiRoute(FunctionID, 2f, "deductcode/employer", typeof(DeductCode))]
        ...
        protected virtual async Task<EntityList<DeductCode>> Load(int? id)
        {
            if ((Provider.Items.Count <= 0) || (id != null && !Provider.Items.Exists(i => i.Id == id)))
            {
                ...
                builder.AppendEquals(DeductCodeBase.Columns.EmployerPaid, "1");
                if (id == null)
                {
        ...
        protected virtual async Task<DeductCode> ProcessBodyItem(bool isCreate, dynamic bodyItem, int? id)
        {
            ...
            if (isCreate)
            {
                ...
                entity.EmployerPaid = Convert.ToBoolean(1);
            }
            else if (entity == null)
        ...
        #region Properties
        private DeductCodeProvider Provider { get; } = new DeductCodeProvider();
        ...
        #region Fields
        public const string FunctionID = "17E12FE8-2FCF-4461-9023-3C937CF9E9E6";
        #endregion Fields
    }
}
