...
{
    public class ApiInTransferBatchCodeController : ApiControllerBase
    {
        #region Web Methods
        [ApiRoute(FunctionID, 2f, "transferbatch/{id?}", typeof(TransferBatch))]
        ...
        protected virtual async Task<List<TransferBatch>> ProcessEditRequest(bool isCreate, dynamic body, string id = null)
        {
            object[] list;
        ...
        #region Fields
        private const string FunctionID = "186A8D00-0303-4F99-B842-866C998CE8EE";
        #endregion Fields
    }
}
